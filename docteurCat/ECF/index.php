...
if (!empty($_GET) && isset($_GET)) {
    ...
    } else if (!empty($_GET['action']) && $_GET['action'] === 'forum') {
        require_once __DIR__ . '/src/view/forumView.php';
    } else if (!empty($_GET['action']) && $_GET['action'] === 'topic') {
        require_once __DIR__ . '/src/view/topicView.php';
    } else if (!empty($_GET['action']) && $_GET['action'] === 'participate') {
        require_once __DIR__ . '/src/view/participateView.php';
    }
    ...
    if (isset($_SESSION['user'])) {
        ...
        } else if (!empty($_GET['action']) && $_GET['action'] === 'supprimer') {
            $id = $_SESSION['user']['id'];
            if ($user->supprimer($id)) {
